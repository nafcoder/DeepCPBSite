...
# Read training data
others = ['ESM-2-train', 'word_embedding-train']
...
model = BinaryClassifierUndersample(input_size)
...
for epoch in range(180):
    for i, (inputs, labels) in enumerate(train_dataloader):
        ...
        with torch.no_grad():
            print(f'Epoch [{epoch + 1}/{180}], Step [{i + 1}/{len(train_dataloader)}]')


print("Training finished.")

file = f'undersample_without_struct.pth'
